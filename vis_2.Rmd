...
viridis: color scheme that works well with color blindness and black and white. 
...
pulse_df = 
  ...
  pivot_longer(
   ...
   names_to = "visit",
   values_to = "bdi_score_"
  ) |>
  mutate(visit = ifelse(visit == "bl", "00m",))
...
Make an FAS plot. separate after 3 points
```{r}
litters_df = 
